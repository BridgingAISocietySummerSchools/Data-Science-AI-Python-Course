...
The depth of the course: **14 notebooks, roughly 11–13 hours** of focused work. It revisits everything from the [90-minute Introduction Session](../01_introduction/) in substantially more detail, then goes far beyond it — data cleaning, exploratory data analysis, machine learning with scikit-learn, and an introduction to PyTorch, finishing with an end-to-end capstone project.
